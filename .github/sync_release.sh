...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-QBert_MiSTer.git"
CORE_NAME=(Arcade-QBert)
...
UPSTREAM_CORE_NAME=(Arcade-QBert)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-QBert.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-QBert.rbf)
